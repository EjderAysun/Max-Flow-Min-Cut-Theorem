...
public class Main {
        ...
        System.out.println("\n------------");
        System.out.println("G1 iterations (Widest Path Max Flow Algorithm): ");
        Graph G13 = Graph1();
        MaxFlowAlgorithm.WidestPathMaxFlowAlgorithm(G13);
        printEdgeInfo(G13);
        ...
        System.out.println("\n------------");
        System.out.println("G2 iterations (Widest Path Max Flow Algorithm): ");
        Graph G23 = Graph2();
        MaxFlowAlgorithm.WidestPathMaxFlowAlgorithm(G23);
        printEdgeInfo(G23);
        ...
        System.out.println("\n------------");
        System.out.println("G3 iterations (Widest Path Max Flow Algorithm): ");
        Graph G33 = Graph3();
        MaxFlowAlgorithm.WidestPathMaxFlowAlgorithm(G33);
        printEdgeInfo(G33);
        ...
        System.out.println("\n------------");
        System.out.println("G4 iterations (Widest Path Max Flow Algorithm): ");
        Graph G43 = Graph4();
        MaxFlowAlgorithm.WidestPathMaxFlowAlgorithm(G43);
        printEdgeInfo(G43);
        ...
        System.out.println("\n------------");
        System.out.println("G5 iterations (Widest Path Max Flow Algorithm): ");
        Graph G53 = Graph5();
        MaxFlowAlgorithm.WidestPathMaxFlowAlgorithm(G53);
        printEdgeInfo(G53);
